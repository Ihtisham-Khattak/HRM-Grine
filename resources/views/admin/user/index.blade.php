    ...
    <div class="col-12">
        <div class="card flex-fill">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <a href="{{ Auth::user()->role->slug === 'super-admin' ? route('user.create') : route('admin.users.create')  }}"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td width="90px" class="d-flex">
                            <a href="{{ Auth::user()->role->slug === 'super-admin' ? route('user.edit', $user->id) : route('admin.users.edit', $user->id) }}"
                                class="btn btn-outline-primary btn-sm me-1">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form
                                action="{{ Auth::user()->role->slug === 'super-admin' ? route('user.destroy', $user->id) : route('admin.users.destroy', $user->id)}}"
                                method="post">
                                @csrf
                                @method("delete")
